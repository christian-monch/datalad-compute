# -*- coding: utf-8 -*-
#
# datalad_compute documentation build configuration file, created by
        ...
        try:
            subprocess.run(
                args=[setup_py_path, 'build_manpage',
                     '--cmdsuite', 'datalad_compute:command_suite',
                     '--manpath', abspath(opj(
...
# built documents.
version = datalad_compute.__version__
release = version
